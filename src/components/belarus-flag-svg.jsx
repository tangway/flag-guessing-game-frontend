...
const BelarusFlag = ({ animate, initial, transition, ...props }) => (
  <svg
  ...
  >
    ...
    />
    <g fill="#fff" clipPath="url(#p)" transform="translate(2) scale(.21)">
      <g id="b">
        <path
          id="a"
        ...
        />
        <use xlinkHref="#a" transform="matrix(-1 0 0 1 200 0)" />
      ...
      <use xlinkHref="#b" transform="matrix(1 0 0 -1 0 900)" />
